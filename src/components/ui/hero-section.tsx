    ...
    <section className="relative overflow-hidden bg-gradient-hero">
      ...
      <div className="container relative py-20 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 text-lg text-white/80 md:text-xl lg:text-2xl max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button 
              size="lg" 
              className="bg-accent hover:bg-accent/90 text-black font-semibold px-8 py-4 shadow-glow transition-bounce hover:scale-105"
            >
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <img
              ...
              className="rounded-2xl shadow-2xl border border-white/20 animate-pulse-glow"
            />
          </div>
        </div>
      </div>
